...
import { deleteProduct, getProductId, updateProduct } from "../../store/products/action"
...
export default function Edit() {
    ...
    const { productDataId, loading, success, error, } = useSelector(state => ({
        loading: state.products.loading,
        productDataId: state.products.productDataId,
    ...
    const validation = useFormik({
        ...
        initialValues: {
            name: productDataId?.name || '',
            description: productDataId?.description || '',
            unit_price: productDataId?.unit_price || '',
        },
